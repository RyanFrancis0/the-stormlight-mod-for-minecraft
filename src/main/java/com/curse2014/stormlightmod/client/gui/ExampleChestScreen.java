package com.curse2014.stormlightmod.client.gui;
...
public class ExampleChestScreen extends ContainerScreen<ExampleChestContainer> {
	...
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(StormlightMod.MOD_ID, "textures/gui/example_chest.png");
